...
4. When the tests pass, update @IMPLEMENTATION_PLAN.md (always keep that file updated!), then `git add -A` then `git commit` in a subagent with a message describing the changes.
